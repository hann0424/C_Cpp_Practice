...
int main(void)
{
	...
	i = 2.2;			insertFirstNode(&list2, &d); // [2.2, 4.4]
	i = 1.1; 			insertFirstNode(&list2, &d); // [1.1, 2.2, 4.4]
	
	double f = 2.2;
	i = 3.3;
	insertNode(&list1, &f, &d);	// [1.1, 2.2, 3.3, 4.4]
	
	i = 2.2; 	deleteNode(&list1, &d);		// [1.1, 3.3, 4.4]
